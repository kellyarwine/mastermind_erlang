-module(console_io).
-export([display/2, get_guess/0, get_play_again/0, display_welcome_message/0, display_invalid_selection/0, display_game_decision/2, display_gameboard/1, turn_data/1]).
